...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{images/vue densemble .png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{images/vue group .png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{images/causes.png}
...
\begin{minted}[fontsize=\footnotesize,breaklines,linenos]{sql}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/query_performance_comparison.png}
